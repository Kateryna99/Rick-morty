    ...
    return (
        <div className={styles.grid}>
            <div className={styles.gridWrapper}>
                ...
                <Link href='https://www.netflix.com/at-en/title/80014749' target='_blank'
                      className={classNames(styles.gridItem,styles.transformRight, styles.announce)}>
                    <div className={styles.announceWrapper}>
                        <div className={styles.announceHeader}>
                            <Loader progressValue={ProgressValue.announceDate}
                        ...
                        <main className={styles.announceMain}>
                            ...
                            <span className={classNames(styles.announceIcon, "icon-netflix_logo")}/>
                        </main>
